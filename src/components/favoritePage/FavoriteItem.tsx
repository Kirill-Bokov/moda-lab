...
import { FavoriteItemRemoveButton } from "./FavoriteItemRemoveButton"
...
import { FavoriteToCartButton } from "./FavoriteToCartButton"
...
export function FavoriteItem({ item }: Props) {
    ...
    return (
        <div className="flex items-center gap-4 border p-4 rounded">
            ...
            <FavoriteItemRemoveButton itemId={item.id} />
        </div>
    )
}
